...
class testconfig(unittest.TestCase):
    def testconfig(self):
        ...
        self.assertEqual('/dev/ttyUSB2', conf.read('antennaport'))
        self.assertEqual('9600', conf.read('antennabaudrate'))
        self.assertEqual('/dev/ttyUSB1', conf.read('radioport'))
        ...
        self.assertEqual('/dev/ttyUSB2', data['antennaport'])
        self.assertEqual('9600', data['antennabaudrate'])
        self.assertEqual('/dev/ttyUSB1', data['radioport'])
